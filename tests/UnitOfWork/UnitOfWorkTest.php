...
use Joomla\ORM\Tests\DumpTrait;
use Joomla\ORM\Tests\Mocks\UnitOfWorkAccessDecorator;
...
class UnitOfWorkTest extends TestCase
{
    ...
    public function testChangesAreDetected()
    {
        ...
        $this->assertContains($this->entity1, $this->unitOfWork->getScheduledEntityInsertions(),
            "Entity should have been scheduled for insertion");
        $this->assertNotContains($this->entity1, $this->unitOfWork->getScheduledEntityUpdates(),
            "Entity should not have been scheduled for update");
         ...
         */
        $this->assertContains($this->entity1, $this->unitOfWork->getScheduledEntityInsertions(),
            "Entity should still be scheduled for insertion");
        $this->assertNotContains($this->entity1, $this->unitOfWork->getScheduledEntityUpdates(),
            "Entity should still not be scheduled for update");
        ...
        $this->assertNotContains($this->entity1, $this->unitOfWork->getScheduledEntityInsertions(),
            "Entity should not longer be scheduled for insertion");
        $this->assertContains($this->entity1, $this->unitOfWork->getScheduledEntityUpdates(),
            "Entity should now be scheduled for update");
    }
    ...
    private function getInsertedEntity()
    {
        ...
        /** @var User $entity */
        $entity = $this->entityRegistry->getEntity($className, $foo->getId());
     ...
     */
    public function testEntityIdIsBeingSetAfterCommit()
    {
        $foo = $this->getInsertedEntity();
